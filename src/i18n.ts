...
const en: Dict = {
  ...
  world_n: "World {n}",
  worlds: "Worlds",
  worlds_title: "World Manager",
  new_world_btn: "New World",
  no_worlds: "No worlds yet. Create your first one!",
  create_first: "Create First World",
  world_select: "Select World",
  delete_world: "Delete",
  confirm_delete: "Delete this world?",
  name_your_world: "Name your world:",
  world_name_placeholder: "My awesome world",
  save_quit: "Save & Quit",
...
const ru: Dict = {
  ...
  world_n: "Мир {n}",
  worlds: "Миры",
  worlds_title: "Управление мирами",
  new_world_btn: "Новый мир",
  no_worlds: "Пока нет миров. Создай свой первый!",
  create_first: "Создать первый мир",
  world_select: "Выбери мир",
  delete_world: "Удалить",
  confirm_delete: "Удалить этот мир?",
  name_your_world: "Назови свой мир:",
  world_name_placeholder: "Мой крутой мир",
...
const ro: Dict = {
  ...
  world_n: "Lumea {n}",
  worlds: "Lumi",
  worlds_title: "Gestionarea lumilor",
  new_world_btn: "Lume nouă",
  no_worlds: "Nicio lume încă. Creează prima ta!",
  create_first: "Creează prima lume",
  world_select: "Selectează lumea",
  delete_world: "Șterge",
  confirm_delete: "Ștergi această lume?",
  name_your_world: "Numește-ți lumea:",
  world_name_placeholder: "Lumea mea minunată",
